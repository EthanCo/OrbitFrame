...
public abstract class BaseChangeFragment<V, T extends BaseViewModel<V>> extends BaseFragment<V, T> implements IFragmentChanger {
     ...
     */
    @Override
    public void changeFragment(Fragment fragment, String fragmentTag, int containerViewId, boolean isBackStack, boolean useCache) {
        fragmentChanger.changeFragment(fragment, fragmentTag, containerViewId, isBackStack, useCache);
    }
