package com.ethanco.simpleframe.utils.log;
...
public class L {
    ...
    public static final String TAG_DEFAULT = "Z-TAG";
    ...
    private static boolean IS_SHOW_LOG = BaseApplication.IS_DEBUG;
    ...
    private static void printLog(int type, String tagStr, Object... objects) {
        ...
        String tag = null == tagStr ? TAG_DEFAULT : tagStr;
        //String tag = TAG_DEFAULT; //contents[0];
